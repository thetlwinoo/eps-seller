...
@Directive({
    selector: '[rootPerfectScrollbar]'
})
export class RootPerfectScrollbarDirective implements AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set rootPerfectScrollbarOptions(value)
    {
        // Merge the options
        this._options = _.merge({}, this._options, value);
    }

    get rootPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.rootPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.rootPerfectScrollbarOptions
        });
