...
import { RootMatchMediaService, RootConfigService } from '@root/services';
...
export class RootSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._rootSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._rootSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('root-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('root-sidebar-overlay-invisible');
        }
